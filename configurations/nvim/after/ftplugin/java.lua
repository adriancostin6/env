  ...
  settings = {
    java = {
      project = {
        ...
        referencedLibraries = {
--          '/localdev/adrianc/repos/work/swdev/spaces/silver/test/regression-test/GUI/sikuli/jar/sikulixapi-2.0.5-modified.jar',
--          '/localdev/adrianc/repos/work/swdev/spaces/silver/test/regression-test/GUI/sikuli/jar/oculixapi-3.0.2-linux.jar',
        },
