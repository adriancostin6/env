vim.api.nvim_create_autocmd({ "BufReadPre", "BufNewFile" }, {
    ...
    group = vim.api.nvim_create_augroup('ForceFiletype', {}),
})
vim.api.nvim_create_autocmd({ "BufReadPre", "BufNewFile" }, {
    pattern = { "*.sbs" },
...
vim.api.nvim_create_autocmd("FileType", {
    ...
    callback = function(ev)
        ...
        require'adrianc.binds'.markdown()
    end,
...
-- TODO: specify this autocmd function in a separate lsp file handling just JAVA
vim.api.nvim_create_autocmd("FileType", {
  pattern = "java",
  group = vim.api.nvim_create_augroup('Java', {}),
  callback = function()
    local jdtls
    ...
    -- TODO: integrate this into a settings file in project root, and read that
...
vim.api.nvim_create_autocmd('LspAttach', {
  ...
  callback = function(ev)
    ...
    require'adrianc.binds'.lsp(opts)
  end,
})
